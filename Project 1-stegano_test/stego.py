...
logo_img = logo_img.resize((100, 100), Image.LANCZOS)  # Change (100, 100) to your desired width and height
logo = ImageTk.PhotoImage(logo_img)
Label(root,image=logo,bg="white").place(x=10,y=0)

Label(root,text="CYBER SECURITY",bg="white",fg="black",font="arial 25 bold").place(x=150,y=10)
